...
public class GaleryAdapter extends RecyclerView.Adapter<GaleryAdapter.ViewHolder> {
    ...
    public GaleryAdapter(Oncallback mListener, List<String> listhinh, User user, User cr, LinearLayout linearLayout) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final GaleryAdapter.ViewHolder holder, final int position) {
        if (listhinh != null) {
