...
public class ListFindNearUserAdapter extends RecyclerView.Adapter<ListFindNearUserAdapter.ViewHolder> {
    private List<User> listUser;
    private OnCallBack mListener;
    private User mCurrent;
    private Context mContext;

    public ListFindNearUserAdapter(List<User> listUser, OnCallBack mListener, User mCurrent) {
    ...
    @NonNull
    @Override
    public ListFindNearUserAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ListFindNearUserAdapter.ViewHolder viewHolder, int i) {
        ...
        double location = Math.round(MapUtils.CalculationByDistance(locationUser,locationOther)*10)/10;
        viewHolder.tvLocation.setText("Cách " + location + " Km");
    }
