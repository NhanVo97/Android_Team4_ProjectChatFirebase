...
public class PermissionAdapter extends BaseAdapter {
    ...
    public PermissionAdapter(List<Quyen> listQuyen, Context mContext, String quyen) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final Quyen permission = listQuyen.get(position);
        viewHolder.tvCap.setText(permission.getCap());
        viewHolder.rdQuyen.setText(permission.getName());
