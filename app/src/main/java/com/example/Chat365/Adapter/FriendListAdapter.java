...
public class FriendListAdapter extends RecyclerView.Adapter<FriendListAdapter.ViewHolder> {
    ...
    String searchKey;
    public FriendListAdapter(List<Friends> listFriends, OnCallBack mListener,
    ...
    @Override
    public void onBindViewHolder(@NonNull final FriendListAdapter.ViewHolder viewHolder, int i) {
