...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> implements GaleryAdapter.Oncallback {
    ...
    public void onBindViewHolder(@NonNull final PostAdapter.ViewHolder holder, final int position) {
        ...
        if (postStatus.getLinkGalery() == null) {
            ...
            listHinh = postStatus.getLinkGalery();
            holder.grHinh.setHasFixedSize(true);
            holder.grHinh.setLayoutManager(new GridLayoutManager(mContext, 3));
            galeryAdapter = new GaleryAdapter(this, listHinh, null, null, null);
            holder.grHinh.setAdapter(galeryAdapter);
        }
        if (postStatus.getListComment() != null) {
            holder.tvComment.setText(postStatus.getListComment().size() + " bình luận");
        }
        ...
        holder.btnComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (postStatus.getListComment() == null) {
                    ...
                    commentList.clear();
                    for (Map.Entry<String, Comment> entry : postStatus.getListComment().entrySet()) {
...
//                    });
                    ...
                    public boolean onKey(View v, int keyCode, KeyEvent event) {
                        if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                            ...
                            if (!ND.equals("")) {
                                ...
                                mData.child("PostActivity").child(postStatus.getKey()).child("listComment").child(key).setValue(comment);
                                mData.child("PostActivity").child(postStatus.getKey()).child("listComment").child(key).child("time").setValue(ServerValue.TIMESTAMP);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            grHinh = itemView.findViewById(R.id.rcHinhPost);
            layoutcomment = itemView.findViewById(R.id.layoutcomment);
            imAvatarComment = itemView.findViewById(R.id.imAvtComment);
            NDComment = itemView.findViewById(R.id.ndSubComment);
            rvListComment = itemView.findViewById(R.id.rcSubComment);
